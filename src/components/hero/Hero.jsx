  ...
  return (
    <div className='hero flex items-center flex-col gap-8 pb-20 pt-4' id='home'>
      ...
      <div className="hero-action flex flex-col md:flex-row gap-4 text-xl text-[rgb(0,0,33)]">
        <button className="hero-connect px-10 py-2 bg-gray-100 hover:bg-purple-700 hover:text-white rounded-full cursor-pointer text-lg transition duration-200">
        ...
        <a href="/saikatresume.pdf" download>
          <button className="hero-resume px-10 py-2 bg-gray-100 hover:bg-purple-700 hover:text-white rounded-full cursor-pointer text-lg transition duration-200">
            My Resume
          </button>
        </a>
      </div>

...
const Hero = () => {
  return (
    <div className='hero flex items-center flex-col gap-8 pb-20' id='home'>
      ...
      <h1 className='mt-16 sm:mt-0 w-2/3 md:text-5xl text-2xl text-center text-white'>I'm <span className='text-purple-800'>Saikat Saha</span>, a Passionate <span className='text-purple-800'>Frontend Developer</span> based in India.</h1>

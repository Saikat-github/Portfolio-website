    ...
    <div className='services flex flex-col items-center justify-center gap-20 py-20 mx-40' id='services'>
        ...
        <div className="services-container grid lg:grid-cols-2 xl:grid-cols-3 gap-10 mb-20">
            {Services_Data.map((service, index) => {
                return (
                    <div className="services-format flex flex-col justify-center gap-5 p-6 md:p-16 rounded-lg border-2 transition cursor-pointer hover:border-2 hover:border-pink-400 hover:transition hover:scale-105 hover:bg-gradient-to-tr hover:from-[#3f0028] hover:to-[#582300]" key={index}>

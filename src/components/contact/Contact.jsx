        ...
        <div className="contact flex flex-col items-center gap-16 py-20 px-2" id='contact'>
            ...
            <div className="contact-section flex flex-col lg:flex-row gap-36 items-center">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className='contact-right flex flex-col gap-2 w-full'>
                    ...
                    <input className='border-none outline-none rounded-lg bg-gray-700/50 sm:bg-gray-900 text-gray-100 text-xs px-4 py-2' type="text" placeholder='Enter your name' {...register("name", {required: true})} />

                    <label className='text-sm text-gray-100'>Your Email</label>
                    <input className='border-none outline-none rounded-lg bg-gray-700/50 sm:bg-gray-900 text-gray-100 text-xs px-4 py-2' type="email" placeholder='Enter your email' {...register("email", {required: true})} />

                    <label className='text-sm text-gray-100'>Write your message here</label>
                    <textarea {...register("message", {required: true})} placeholder='Enter your message' className='border-none outline-none lg:h-32 rounded-lg bg-gray-700/50 sm:bg-gray-900 text-gray-100 text-xs px-4 py-2 pt-4'></textarea>

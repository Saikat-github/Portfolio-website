    ...
    return (
        <div id='about' className='my-10'>
            ...
            <div className="about-right p-4 md:mx-32 space-y-10">
                <p className='text-center my-2 text-sm'>I am an experienced Web Developer with professional expertise in building production grade, highly optimized web application.</p>
                <Technologies />
            </div>
